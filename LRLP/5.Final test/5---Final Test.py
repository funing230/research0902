...
final_label_path = "1214_y_prediction_lPLR76.csv"#"0829_y_prediction_LPLR.csv"#"0829_y_prediction_HPHR.csv"#"0618_y_prediction_HPHR.csv" # "0618_y_prediction_lPLR.csv" "0829_y_prediction_LPLR.csv"
...
plt.plot(predict_port_outa_for_lable, label='LRLP-trained Model',color='r')
